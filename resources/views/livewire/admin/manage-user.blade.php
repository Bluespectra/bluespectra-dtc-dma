		...
		<div class="py-6 px-4 sm:px-6 lg:px-8">
				...
				@if ($editingUserId === null)
						<div class="bg-white shadow-md rounded-lg p-6 mb-6">
								<h2 class="text-lg font-semibold mb-4">Add New Assessor Account</h2>
								<form wire:submit="createUser">
										<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
												<div>
														<label class="block text-sm font-medium text-gray-700">Name</label>
														<input type="text" wire:model="name" placeholder="Musa Obinna"
												...
												<div>
														...
														<input type="tel" wire:model="phone" placeholder="081234567890"
																class="mt-1 block w-full border rounded-md shadow-sm p-2">
														@error('phone')
																<span class="text-red-500 text-sm">{{ $message }}</span>
														@enderror
												...
												<div>
														...
														<select wire:model="role_id" id="role_id" class="mt-1 block w-full border rounded-md shadow-sm p-2">
				...
				@else
						<div class="bg-white shadow-md rounded-lg p-6 mb-6">
								<h2 class="text-lg font-semibold mb-4">Edit User Account</h2>
				...
				<div class="bg-white shadow-md rounded-lg overflow-hidden">
						<div class="px-6 py-4 flex justify-end">
								<select wire:model.live="roleFilter" class="border rounded-lg px-3 py-2">
