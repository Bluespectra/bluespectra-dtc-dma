...
<div class="max-w-4xl mx-auto p-4 sm:p-6">
		...
		<div wire:loading wire:target="saveAssessment"
				...
				<div class="bg-white p-4 sm:p-8 rounded-lg shadow-xl text-center mx-4">
						...
						<p class="text-xs sm:text-sm text-gray-600 mt-2">Please wait while we process your responses and prepare your
								report.</p>
				</div>
		</div>
		...
		@if ($currentSection < 0)
				...
				<div class="bg-white p-4 sm:p-6 rounded-lg shadow-lg mb-6 sm:mb-8">
						...
						<div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
								<div>
										<label class="block mb-2 text-sm sm:text-base font-medium">Respondent Name <span
														class="text-red-500 text-sm">*</span></label>
										<input type="text" wire:model="personalInfo.respondent_name"
												class="w-full border rounded-lg p-3 text-base">
										@error('personalInfo.respondent_name')
												<span class="text-red-500 text-sm">{{ $message }}</span>
										@enderror
								</div>

								<div>
										<label class="block mb-2 text-sm sm:text-base font-medium">Gender <span
														class="text-red-500 text-sm">*</span></label>
										...
										@error('personalInfo.gender')
												<span class="text-red-500 text-sm">{{ $message }}</span>
										@enderror
								</div>

								<div>
										<label class="block mb-2 text-sm sm:text-base font-medium">Migration Status <span
														class="text-red-500 text-sm">*</span></label>
										...
										@error('personalInfo.migration_status')
												<span class="text-red-500 text-sm">{{ $message }}</span>
										@enderror
								</div>

								<div>
										<label class="block mb-2 text-sm sm:text-base font-medium">Phone Number 1 <span
														class="text-red-500 text-sm">*</span></label>
										<input type="tel" wire:model="personalInfo.phone_number_1" class="w-full border rounded-lg p-3 text-base">
										@error('personalInfo.phone_number_1')
												<span class="text-red-500 text-sm">{{ $message }}</span>
										@enderror
								</div>

								<div>
										<label class="block mb-2 text-sm sm:text-base font-medium">Phone Number 2 <span
														class="text-red-500 text-sm">*</span></label>
										<input type="tel" wire:model="personalInfo.phone_number_2" class="w-full border rounded-lg p-3 text-base">
										@error('personalInfo.phone_number_2')
												<span class="text-red-500 text-sm">{{ $message }}</span>
										@enderror
								</div>

								<div>
										<label class="block mb-2 text-sm sm:text-base font-medium">Email <span
														class="text-red-500 text-sm">*</span></label>
								...
								<div>
										<label class="block mb-2 text-sm sm:text-base font-medium">State <span
														class="text-red-500 text-sm">*</span></label>
								...
								<div>
										...
										<input type="text" wire:model="digitalAdvisorName"
												class="w-full border rounded-lg p-3 text-base bg-gray-50" readonly>
										<input type="hidden" wire:model="personalInfo.digital_advisor">
								</div>
								<div>
										<label class="block mb-2 text-sm sm:text-base font-medium">Account Role</label>
										<input type="text" wire:model="accountRole" class="w-full border rounded-lg p-3 text-base bg-gray-50"
												readonly>
										<input type="hidden" wire:model="personalInfo.account_role">
								</div>
								...
								<div class="md:col-span-2">
										...
										@error('personalInfo.consent_given')
												<span class="text-red-500 text-sm">{{ $message }}</span>
										@enderror
								</div>
						</div>
				...
				<div class="bg-white p-4 sm:p-6 rounded-lg shadow-lg mb-6 sm:mb-8">
						...
						<div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
								<div>
										<label class="block mb-2 text-sm sm:text-base font-medium">Business Name <span
														class="text-red-500 text-sm">*</span></label>
										<input type="text" wire:model="businessInfo.business_name" class="w-full border rounded-lg p-3 text-base">
										@error('businessInfo.business_name')
												<span class="text-red-500 text-sm">{{ $message }}</span>
										@enderror
								</div>

								<div>
										<label class="block mb-2 text-sm sm:text-base font-medium">Business Phone Number <span
														class="text-red-500 text-sm">*</span></label>
										<input type="tel" wire:model="businessInfo.business_phone_number"
												class="w-full border rounded-lg p-3 text-base">
										@error('businessInfo.business_phone_number')
												<span class="text-red-500 text-sm">{{ $message }}</span>
										@enderror
								</div>

								<div>
										<label class="block mb-2 text-sm sm:text-base font-medium">Business Email <span
														class="text-red-500 text-sm">*</span></label>
										<input type="email" wire:model="businessInfo.business_email"
												class="w-full border rounded-lg p-3 text-base">
										@error('businessInfo.business_email')
												<span class="text-red-500 text-sm">{{ $message }}</span>
										@enderror
								</div>

								<div>
										<label class="block mb-2 text-sm sm:text-base font-medium">Business State <span
														class="text-red-500 text-sm">*</span></label>
										...
										@error('businessInfo.business_state')
												<span class="text-red-500 text-sm">{{ $message }}</span>
										@enderror
								</div>

								<div>
										<label class="block mb-2 text-sm sm:text-base font-medium">Business City <span
														class="text-red-500 text-sm">*</span></label>
										<input type="text" wire:model="businessInfo.business_city"
												class="w-full border rounded-lg p-3 text-base">
										@error('businessInfo.business_city')
												<span class="text-red-500 text-sm">{{ $message }}</span>
										@enderror
								</div>

								<div>
										<label class="block mb-2 text-sm sm:text-base font-medium">Business Sector <span
														class="text-red-500 text-sm">*</span></label>
										...
										@error('businessInfo.business_sector')
												<span class="text-red-500 text-sm">{{ $message }}</span>
										@enderror
								</div>

								<div>
										<label class="block mb-2 text-sm sm:text-base font-medium">Business Type <span
														class="text-red-500 text-sm">*</span></label>
										<input type="text" wire:model="businessInfo.business_type"
												class="w-full border rounded-lg p-3 text-base">
										@error('businessInfo.business_type')
												<span class="text-red-500 text-sm">{{ $message }}</span>
										@enderror
								</div>

								<div>
										<label class="block mb-2 text-sm sm:text-base font-medium">Business Role <span
														class="text-red-500 text-sm">*</span></label>
										<input type="text" wire:model="businessInfo.business_role"
												class="w-full border rounded-lg p-3 text-base">
										@error('businessInfo.business_role')
												<span class="text-red-500 text-sm">{{ $message }}</span>
										@enderror
								</div>

								<div>
										<label class="block mb-2 text-sm sm:text-base font-medium">Years in Business <span
														class="text-red-500 text-sm">*</span></label>
										<input type="number" wire:model="businessInfo.years_in_business"
												class="w-full border rounded-lg p-3 text-base">
										@error('businessInfo.years_in_business')
												<span class="text-red-500 text-sm">{{ $message }}</span>
										@enderror
								</div>

								<div>
										<label class="block mb-2 text-sm sm:text-base font-medium">Staff Size <span
														class="text-red-500 text-sm">*</span></label>
								...
								<div class="md:col-span-2">
										...
										@if ($businessInfo['multiple_states'])
												<div class="mt-2">
														<input type="text" wire:model="businessInfo.operating_states"
																placeholder="List the states (comma separated)" class="w-full border rounded-lg p-3 text-base">
														@error('businessInfo.operating_states')
																<span class="text-red-500 text-sm">{{ $message }}</span>
														@enderror
												</div>
										@endif
		...
		@else
				...
				<div class="mb-6 sm:mb-8">
						...
						<div class="md:hidden mb-4">
								<div class="flex justify-between items-center">
										<span class="text-sm font-medium text-gray-500">Step {{ $currentSection + 1 }} of
												{{ count($sectionNames) }}</span>
								...
								<div class="mt-2 h-2 bg-gray-200 rounded-full">
										<div class="h-2 bg-green-600 rounded-full"
												style="width: {{ (($currentSection + 1) / count($sectionNames)) * 100 }}%"></div>
								</div>
						</div>
										...
										@foreach ($sectionNames as $index => $sectionName)
												<div class="flex flex-col items-center flex-1">
														<div class="relative flex items-center justify-center w-full">
																<div
																		class="w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center {{ $index <= $currentSection ? 'bg-green-600 text-white' : 'bg-gray-300 text-gray-600' }} z-10">
																		{{ $index + 1 }}
																</div>
																@if ($index < count($sectionNames) - 1)
																		<div
																				class="absolute h-1 bg-{{ $index < $currentSection ? 'green' : 'gray' }}-300 left-1/2 right-0 w-full">
																		</div>
																@endif
														</div>
														<span
																class="text-xs sm:text-sm mt-2 text-center {{ $index <= $currentSection ? 'text-green-500 font-medium' : 'text-gray-500' }}">
																@php
																		...
																		@foreach ($question['options'] as $option)
																				<label class="flex items-center p-2 hover:bg-gray-50 rounded">
																						<input type="checkbox" wire:model="answers.{{ $question['id'] }}"
																								value="{{ $option['text'] }}" class="w-5 h-5 mr-3">
																						<span class="text-sm sm:text-base">{{ $option['text'] }}</span>
																				</label>
																		@endforeach
																</div>
														@elseif($question['type'] === 'select')
																<select wire:model="answers.{{ $question['id'] }}" class="w-full p-3 border rounded-lg text-base">
						...
						<div class="flex flex-col sm:flex-row justify-between gap-4 mt-6 sm:mt-8">
								@if ($currentSection > 0)
										<button wire:click="previousSection"
												...
												wire:loading.attr="disabled" wire:target="previousSection">
												Previous Section
										</button>
								@else
										<div></div>
								...
								@else
										<button wire:click="saveAssessment"
												class="w-full sm:w-auto bg-green-500 text-white px-6 py-3 rounded-lg hover:bg-green-600 text-base"
												wire:loading.attr="disabled" wire:target="saveAssessment">
				...
				@else
						...
						<div class="space-y-6 sm:space-y-8">
								...
								<h2 class="text-xl sm:text-2xl font-bold">Digital Maturity Assessment Results:
										{{ $businessInfo['business_name'] }}</h2>
								<!-- Overall Score Card -->
								@php
								...
								<div class="p-6 rounded-lg shadow-lg border-2 {{ $bgColor }}">
										...
										<div class="space-y-4">
												...
												<div class="w-full bg-gray-200 rounded-full h-3">
														<div class="{{ $progressColor }} h-3 rounded-full" style="width: {{ $overallScore['percentage'] }}%">
														</div>
												</div>
										</div>
